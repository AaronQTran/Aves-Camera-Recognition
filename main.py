...
while True:
    ...
    for (bx1, by1, bx2, by2, id) in body_results:
        cv2.rectangle(frame, (bx1, by1), (bx2, by2), (0, 255, 0), 2)
        cv2.putText(frame, str(id), (bx1, by1 - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 255, 0), 2)

        for identity, (fx1, fy1, fx2, fy2) in face_results:
            if fx1 >= bx1 and fy1 >= by1 and fx2 <= bx2 and fy2 <= by2:
                cv2.putText(frame, identity, (bx1, by1 - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 255, 0), 2)
                break
