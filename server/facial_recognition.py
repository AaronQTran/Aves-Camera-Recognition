...
known_faces_path = os.path.join(data_dir, 'known_faces.pt')

# Load the known faces
known_faces = torch.load(known_faces_path) #given a frame, make a func that returns the box coords and label of the face
